    ...
    return (
        <Container>
            <Row className="mt-3 mb-3">
                <Col lg={4}>
                    {product.image ? (
                        <Image width={200} height={150} src={process.env.REACT_APP_IMG_URL + product.image} />
                    ) : (
                        <Image width={200} height={150} src="http://via.placeholder.com/300" />
                    )}
                </Col>
                <Col lg={8}>
                    <h1>{product.name}</h1>
                    <h3>{product.price}.00 грн.</h3>
